...
function toTreeByRecursion(
  ...
  return cloneData.filter((parent) => {
    ...
    if (branchArr.length > 0) {
      ...
      if (parent.bSelect !== undefined) {
        parent.checked = parent.bSelect;
      } else {
 ...
 * @param {Object} treeOption tree树形配置
 */
function toSysRoleMenuTreeByRecursion(
  source = [],
  idField = 'id',
  parentIdField = 'parentId',
  parentIdNoneValue = '',
 ...
 * @param {Object} treeOption tree树形配置
 */
function toMenuTreeByRecursion(
  source = [],
  idField = 'id',
  parentIdField = 'parentId',
  parentIdNoneValue = '',
...
module.exports = {
  toTreeByRecursion,
  toMenuTreeByRecursion,
  toSysRoleMenuTreeByRecursion,
};
