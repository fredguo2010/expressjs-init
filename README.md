...
```bash
git clone --depth 1 https://gitlab.raiad.cn/shanghai-iad-poc-group/innovation-application-dev/rarockii_init_node_backend_mssqlv1.git
cd rarockii_init_node_backend_mssqlv1
npx rimraf ./.git
```
...
The paginate plugin adds the `paginate` static method to.
